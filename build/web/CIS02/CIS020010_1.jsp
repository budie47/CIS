...
String sqlRIS = "SELECT ris_order_master.order_no,ris_detail_order.procedure_cd, ris_detail_order.ris_procedure_name, ris_detail_order.modality_name, ris_detail_order.body_system_name, ris_detail_order.remarks FROM  ris_detail_order INNER JOIN ris_order_master ON ris_detail_order.order_no = ris_order_master.order_no WHERE ris_order_master.pmi_no ='"+pmiNo+"' AND ris_order_master.hfc_cd = '" +hfc_cd+"'";
